		...
		<div class="box">
			<div class="box-header">
				...
				<form method="get" action="">
					...
					&nbsp;
					 <!-- <form action="<?= site_url('spoutcontroller/exportExcel'); ?>" method="post">
    <button class="btn btn-custom-gray btn-lg" type="submit">ออกรายการ Excel</button>
</form> -->
				...
				<a href="<?= site_url('repair_system/admin/admin_list'); ?>?status=3" class="btn btn-success"> สำเร็จ
					<span class="badge">
						<?= $count_case_finish; ?>
					</span></a>
